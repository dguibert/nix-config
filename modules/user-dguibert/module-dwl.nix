...
{
  flake.aspects.dguibert-dwl.nixos.home-manager.users.dguibert.imports = [
    config.flake.modules.homeManager.dguibert-dwl
  ];
  flake.aspects.dguibert-dwl.homeManager =
    { pkgs, config, ... }:
    let
