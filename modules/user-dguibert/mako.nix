...
{
  flake.aspects.dguibert-mako.nixos.home-manager.users.dguibert.imports = [
    config.flake.modules.homeManager.dguibert-mako
  ];
  flake.aspects.dguibert-mako.homeManager =
    { pkgs, config, ... }:
    let
