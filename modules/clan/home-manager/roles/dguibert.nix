...
in
{
  ...
  options = {
    clan.home-manager.dguibert.withGui.enable = (mkEnableOption "Host running with X11 or Wayland") // { default = false; };
    clan.home-manager.dguibert.withPersistence.enable = mkEnableOption "Use Impermanence";
    clan.home-manager.dguibert.centralMailHost.enable = mkEnableOption "Host running liier/mbsync";
  };
